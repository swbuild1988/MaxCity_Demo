...
import { HumiditySensorBridgeData, AssetManageData } from '@/types/views/humiditySensorBridge.interface'
...
export default class About extends Vue {
    ...
    humidityBridgeWrapBackMap: string = require('../../assets/images/bridgeAccele.png')

    // data
    data: HumiditySensorBridgeData = {
        toPointData: [
            {
