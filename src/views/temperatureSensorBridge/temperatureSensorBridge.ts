...
import { TemperatureSensorBridgeData, AssetManageData } from '@/types/views/temperatureSensorBridge.interface'
...
export default class About extends Vue {
    ...
    temperatureSensorBridgeWrapBackMap: string = require('../../assets/images/temperaturWrap.png')

    // data
    data: TemperatureSensorBridgeData = {
        toPointData: [
            {
